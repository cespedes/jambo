// Copied from https://github.com/laher/mergefs
...
// Merge returns a [fs.FS] combining all the input filesystems.
func Merge(filesystems ...fs.FS) fs.FS {
	return MergedFS{filesystems: filesystems}
}

// MergedFS combines filesystems.
// Each filesystem can serve different paths. The first FS takes precedence.
